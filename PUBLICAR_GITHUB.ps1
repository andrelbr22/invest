...
try {
    ...
    & $gitPath commit -m "Corrige testes de homologacao na V1.23.0 R5 em teste"
    if ($LASTEXITCODE -ne 0) {
...
Write-Host "Depois da atualizacao automatica, valide a V1.23.0 R5 no endereco /testefdi antes de promover."
