...
try {
    ...
    & $gitPath commit -m "Isola autenticação do teste administrativo na V1.22.0 R2"
    if ($LASTEXITCODE -ne 0) {
...
Write-Host "Depois da atualizacao automatica, valide a V1.22.0 R2 no endereco /testefdi antes de promover."
