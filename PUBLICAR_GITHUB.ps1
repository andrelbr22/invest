...
try {
    ...
    & $gitPath commit -m "Corrige atualização do Comparador Histórico na V1.20.7 R3 em teste"
    if ($LASTEXITCODE -ne 0) {
...
Write-Host "Depois da atualizacao automatica, valide a V1.20.7 R3 no endereco /testefdi antes de promover."
