...
try {
    ...
    & $gitPath commit -m "Corrige homologação em contêiner da V1.22.0 R1 em teste"
    if ($LASTEXITCODE -ne 0) {
...
Write-Host "Depois da atualizacao automatica, valide a V1.22.0 R1 no endereco /testefdi antes de promover."
