...
try {
    ...
    & $gitPath commit -m "Corrige rodada semanal de backtests na V1.20.7 R4 em teste"
    if ($LASTEXITCODE -ne 0) {
...
Write-Host "Depois da atualizacao automatica, valide a V1.20.7 R4 no endereco /testefdi antes de promover."
