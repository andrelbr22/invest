...
try {
    ...
    & $gitPath commit -m "Audita valuation, filtros e backtests na V1.21.0 em teste"
    if ($LASTEXITCODE -ne 0) {
...
Write-Host "Depois da atualizacao automatica, valide a V1.21.0 no endereco /testefdi antes de promover."
