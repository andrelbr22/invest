...
try {
    ...
    & $gitPath commit -m "Completa proventos oficiais de FIIs na V1.23.0 R6 em teste"
    if ($LASTEXITCODE -ne 0) {
...
Write-Host "Depois da atualizacao automatica, valide a V1.23.0 R6 no endereco /testefdi antes de promover."
