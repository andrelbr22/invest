...
try {
    ...
    & $gitPath commit -m "Corrige proventos e diagnostico do worker na V1.23.0 R4 em teste"
    if ($LASTEXITCODE -ne 0) {
...
Write-Host "Depois da atualizacao automatica, valide a V1.23.0 R4 no endereco /testefdi antes de promover."
